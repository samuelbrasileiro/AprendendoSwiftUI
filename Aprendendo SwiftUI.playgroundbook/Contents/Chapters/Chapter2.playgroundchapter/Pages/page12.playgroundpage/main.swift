/*:
# Desafio 11: Aplicativo de Navegação
...
Parabéns por concluir o Desafio 11 de Aplicativo de Navegação! Agora você tem um aplicativo com várias telas, permitindo que o usuário navegue entre os itens e veja mais informações sobre cada um. Continue praticando e experimentando para aprimorar suas habilidades de navegação com SwiftUI.
